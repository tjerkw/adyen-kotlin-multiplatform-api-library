...
open class TermsOfServiceApi(
    ...
    open suspend fun getLegalEntitiesIdTermsOfServiceAcceptanceInfos(id: kotlin.String): HttpResponse<GetTermsOfServiceAcceptanceInfosResponse> {
        ...
        val localVariableConfig = RequestConfig<kotlin.Any?>(
            RequestMethod.GET,
            "/legalEntities/{id}/termsOfServiceAcceptanceInfos".replace("{" + "id" + "}", "$id"),
     ...
     */
    @Suppress("UNCHECKED_CAST")
    open suspend fun getLegalEntitiesIdTermsOfServiceStatus(id: kotlin.String): HttpResponse<CalculateTermsOfServiceStatusResponse> {
        ...
        val localVariableConfig = RequestConfig<kotlin.Any?>(
            RequestMethod.GET,
            "/legalEntities/{id}/termsOfServiceStatus".replace("{" + "id" + "}", "$id"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
     ...
     */
    @Suppress("UNCHECKED_CAST")
    open suspend fun patchLegalEntitiesIdTermsOfServiceTermsofservicedocumentid(id: kotlin.String, termsofservicedocumentid: kotlin.String, acceptTermsOfServiceRequest: AcceptTermsOfServiceRequest? = null): HttpResponse<AcceptTermsOfServiceResponse> {

        val localVariableAuthNames = listOf<String>("ApiKeyAuth", "BasicAuth")

        val localVariableBody = acceptTermsOfServiceRequest
        ...
        val localVariableConfig = RequestConfig<kotlin.Any?>(
            RequestMethod.PATCH,
            "/legalEntities/{id}/termsOfService/{termsofservicedocumentid}".replace("{" + "id" + "}", "$id").replace("{" + "termsofservicedocumentid" + "}", "$termsofservicedocumentid"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
     ...
     */
    @Suppress("UNCHECKED_CAST")
    open suspend fun postLegalEntitiesIdTermsOfService(id: kotlin.String, getTermsOfServiceDocumentRequest: GetTermsOfServiceDocumentRequest? = null): HttpResponse<GetTermsOfServiceDocumentResponse> {

        val localVariableAuthNames = listOf<String>("ApiKeyAuth", "BasicAuth")

        val localVariableBody = getTermsOfServiceDocumentRequest
        ...
        val localVariableConfig = RequestConfig<kotlin.Any?>(
            RequestMethod.POST,
            "/legalEntities/{id}/termsOfService".replace("{" + "id" + "}", "$id"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
