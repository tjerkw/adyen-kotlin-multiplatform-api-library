...
open class ClientKeyCompanyLevelApi(
    ...
    open suspend fun postCompaniesCompanyIdApiCredentialsApiCredentialIdGenerateClientKey(companyId: kotlin.String, apiCredentialId: kotlin.String): HttpResponse<GenerateClientKeyResponse> {
        ...
        val localVariableConfig = RequestConfig<kotlin.Any?>(
            RequestMethod.POST,
            "/companies/{companyId}/apiCredentials/{apiCredentialId}/generateClientKey".replace("{" + "companyId" + "}", "$companyId").replace("{" + "apiCredentialId" + "}", "$apiCredentialId"),
