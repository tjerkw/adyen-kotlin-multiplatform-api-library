...
data class BusinessLineInfo (
    ...
    @SerialName(value = "service") @Required val service: BusinessLineInfo.Service,
    ...
    @SerialName(value = "capability") val capability: BusinessLineInfo.Capability? = null,
