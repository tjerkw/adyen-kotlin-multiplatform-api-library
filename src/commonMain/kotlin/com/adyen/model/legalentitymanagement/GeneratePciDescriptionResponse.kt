 ...
 */
@Serializable
data class GeneratePciDescriptionResponse (

    /* The generated questionnaires in a base64 encoded format. */
    @SerialName(value = "content") val content: com.adyen.client.infrastructure.Base64ByteArray? = null,
    ...
    @SerialName(value = "pciTemplateReferences") val pciTemplateReferences: kotlin.collections.List<kotlin.String>? = null
