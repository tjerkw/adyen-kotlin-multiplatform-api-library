...
data class DocumentPage (
    ...
    @SerialName(value = "pageName") val pageName: kotlin.String? = null,

    @SerialName(value = "pageNumber") val pageNumber: kotlin.Int? = null,

    @SerialName(value = "type") val type: DocumentPage.Type? = null
     ...
     * 
     *
     * Values: BACK,FRONT,UNDEFINED
     */
    @Serializable
    enum class Type(val value: kotlin.String) {
        @SerialName(value = "BACK") BACK("BACK"),
        @SerialName(value = "FRONT") FRONT("FRONT"),
