 ...
 * @param type Type of Partnership. Possible values:  **limitedPartnership**, **generalPartnership**, **familyPartnership**, **commercialPartnership**, **publicPartnership**, **otherPartnership**, **gbr**, **kgaa**, **cv**, **vof**, **maatschap**, **privateFundLimitedPartnership**, **businessTrustEntity**, or **businessPartnership**.
 ...
 */
@Serializable
data class UnincorporatedPartnership (
    ...
    @SerialName(value = "type") @Required val type: UnincorporatedPartnership.Type,
    ...
    @SerialName(value = "vatAbsenceReason") val vatAbsenceReason: UnincorporatedPartnership.VatAbsenceReason? = null,
     ...
     * Type of Partnership. Possible values:  **limitedPartnership**, **generalPartnership**, **familyPartnership**, **commercialPartnership**, **publicPartnership**, **otherPartnership**, **gbr**, **kgaa**, **cv**, **vof**, **maatschap**, **privateFundLimitedPartnership**, **businessTrustEntity**, or **businessPartnership**.
     *
     * Values: LimitedPartnership,GeneralPartnership,FamilyPartnership,CommercialPartnership,PublicPartnership,OtherPartnership,Gbr,Gmbh,Kgaa,Cv,Vof,Maatschap,PrivateFundLimitedPartnership,BusinessTrustEntity,BusinessPartnership
     */
    @Serializable
    enum class Type(val value: kotlin.String) {
        @SerialName(value = "limitedPartnership") LimitedPartnership("limitedPartnership"),
        @SerialName(value = "generalPartnership") GeneralPartnership("generalPartnership"),
        @SerialName(value = "familyPartnership") FamilyPartnership("familyPartnership"),
        @SerialName(value = "commercialPartnership") CommercialPartnership("commercialPartnership"),
        @SerialName(value = "publicPartnership") PublicPartnership("publicPartnership"),
        @SerialName(value = "otherPartnership") OtherPartnership("otherPartnership"),
        @SerialName(value = "gbr") Gbr("gbr"),
        @SerialName(value = "gmbh") Gmbh("gmbh"),
        @SerialName(value = "kgaa") Kgaa("kgaa"),
        @SerialName(value = "cv") Cv("cv"),
        @SerialName(value = "vof") Vof("vof"),
        @SerialName(value = "maatschap") Maatschap("maatschap"),
        @SerialName(value = "privateFundLimitedPartnership") PrivateFundLimitedPartnership("privateFundLimitedPartnership"),
        @SerialName(value = "businessTrustEntity") BusinessTrustEntity("businessTrustEntity"),
        @SerialName(value = "businessPartnership") BusinessPartnership("businessPartnership");
    }
    /**
     * The reason for not providing a VAT number.  Possible values: **industryExemption**, **belowTaxThreshold**.
     *
