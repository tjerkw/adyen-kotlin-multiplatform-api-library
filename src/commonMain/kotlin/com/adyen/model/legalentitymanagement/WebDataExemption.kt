 ...
 */
@Serializable
data class WebDataExemption (

    /* The reason why the web data was not provided. Possible value: **noOnlinePresence**. */
    @SerialName(value = "reason") val reason: WebDataExemption.Reason? = null
     ...
     * The reason why the web data was not provided. Possible value: **noOnlinePresence**.
     *
     * Values: NoOnlinePresence,NotCollectedDuringOnboarding
     */
    @Serializable
    enum class Reason(val value: kotlin.String) {
        @SerialName(value = "noOnlinePresence") NoOnlinePresence("noOnlinePresence"),
        @SerialName(value = "notCollectedDuringOnboarding") NotCollectedDuringOnboarding("notCollectedDuringOnboarding");
    }
}
