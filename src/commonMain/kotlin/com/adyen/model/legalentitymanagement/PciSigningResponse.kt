 ...
 */
@Serializable
data class PciSigningResponse (

    /* The unique identifiers of the signed PCI documents. */
    @SerialName(value = "pciQuestionnaireIds") val pciQuestionnaireIds: kotlin.collections.List<kotlin.String>? = null,
    ...
    @SerialName(value = "signedBy") val signedBy: kotlin.String? = null
