 ...
 * 
 *
 * @param acceptedBy The legal entity ID of the user accepting the Terms of Service.  For organizations, this must be the individual legal entity ID of an authorized signatory for the organization.  For sole proprietorships, this must be the individual legal entity ID of the owner.
 * @param ipAddress The IP address of the user accepting the Terms of Service.
 */
@Serializable
data class AcceptTermsOfServiceRequest (
    ...
    @SerialName(value = "acceptedBy") @Required val acceptedBy: kotlin.String,
