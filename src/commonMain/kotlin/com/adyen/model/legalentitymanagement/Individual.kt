...
data class Individual (
    ...
    @SerialName(value = "residentialAddress") @Required val residentialAddress: Address,

    @SerialName(value = "birthData") val birthData: BirthData? = null,

    /* The email address of the legal entity. */
    @SerialName(value = "email") val email: kotlin.String? = null,

    @SerialName(value = "identificationData") val identificationData: IdentificationData? = null,
