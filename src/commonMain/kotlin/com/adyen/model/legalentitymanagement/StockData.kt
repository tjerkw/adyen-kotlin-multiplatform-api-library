...
data class StockData (
    ...
    @SerialName(value = "marketIdentifier") val marketIdentifier: kotlin.String? = null,

    /* The 12-digit International Securities Identification Number (ISIN) of the company, without dashes (-). */
    @SerialName(value = "stockNumber") val stockNumber: kotlin.String? = null,

    /* The stock ticker symbol. */
    @SerialName(value = "tickerSymbol") val tickerSymbol: kotlin.String? = null
