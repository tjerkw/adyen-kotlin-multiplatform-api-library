 ...
 */
@Serializable
data class GeneratePciDescriptionRequest (

    /* An array of additional sales channels to generate PCI questionnaires. Include the relevant sales channels if you need your user to sign PCI questionnaires. Not required if you [create stores](https://docs.adyen.com/marketplaces-and-platforms/additional-for-platform-setup/create-stores/) and [add payment methods](https://docs.adyen.com/marketplaces-and-platforms/payment-methods/) before you generate the questionnaires.  Possible values: *  **eCommerce** *  **pos** *  **ecomMoto** *  **posMoto**   */
    @SerialName(value = "additionalSalesChannels") val additionalSalesChannels: kotlin.collections.List<GeneratePciDescriptionRequest.AdditionalSalesChannels>? = null,
     ...
     * An array of additional sales channels to generate PCI questionnaires. Include the relevant sales channels if you need your user to sign PCI questionnaires. Not required if you [create stores](https://docs.adyen.com/marketplaces-and-platforms/additional-for-platform-setup/create-stores/) and [add payment methods](https://docs.adyen.com/marketplaces-and-platforms/payment-methods/) before you generate the questionnaires.  Possible values: *  **eCommerce** *  **pos** *  **ecomMoto** *  **posMoto**  
     *
     * Values: ECommerce,EcomMoto,Pos,PosMoto
     */
    @Serializable
    enum class AdditionalSalesChannels(val value: kotlin.String) {
        @SerialName(value = "eCommerce") ECommerce("eCommerce"),
        @SerialName(value = "ecomMoto") EcomMoto("ecomMoto"),
        @SerialName(value = "pos") Pos("pos"),
        @SerialName(value = "posMoto") PosMoto("posMoto");
    }
}
