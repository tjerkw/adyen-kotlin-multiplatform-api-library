 ...
 */
@Serializable
data class ProcessingTypesRestriction (
    ...
    @SerialName(value = "value") val `value`: kotlin.collections.List<ProcessingTypesRestriction.`Value`>? = null
     ...
     * List of processing types.  Possible values: **atmWithdraw**, **balanceInquiry**, **ecommerce**, **moto**, **pos**, **recurring**, **token**.  
     *
     * Values: AtmWithdraw,BalanceInquiry,Ecommerce,Moto,Pos,Recurring,Token,Unknown
     */
    @Serializable
