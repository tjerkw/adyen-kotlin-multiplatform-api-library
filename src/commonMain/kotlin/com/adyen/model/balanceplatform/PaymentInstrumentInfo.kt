 ...
 */
@Serializable
data class PaymentInstrumentInfo (
    ...
    @SerialName(value = "type") @Required val type: PaymentInstrumentInfo.Type,
    ...
    @SerialName(value = "status") val status: PaymentInstrumentInfo.Status? = null,
    ...
    @SerialName(value = "statusReason") val statusReason: PaymentInstrumentInfo.StatusReason? = null
