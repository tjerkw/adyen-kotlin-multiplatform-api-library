 ...
 */
@Serializable
data class UpdatePaymentInstrument (
    ...
    @SerialName(value = "type") @Required val type: UpdatePaymentInstrument.Type,
    ...
    @SerialName(value = "status") val status: UpdatePaymentInstrument.Status? = null,
    ...
    @SerialName(value = "statusReason") val statusReason: UpdatePaymentInstrument.StatusReason? = null
