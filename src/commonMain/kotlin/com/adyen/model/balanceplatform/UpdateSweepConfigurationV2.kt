 ...
 */
@Serializable
data class UpdateSweepConfigurationV2 (

    /* The type of transfer that results from the sweep.  Possible values:   - **bank**: Sweep to a [transfer instrument](https://docs.adyen.com/api-explorer/#/legalentity/latest/post/transferInstruments__resParam_id).  - **internal**: Transfer to another [balance account](https://docs.adyen.com/api-explorer/#/balanceplatform/latest/post/balanceAccounts__resParam_id) within your platform.  Required when setting `priorities`. */
    @SerialName(value = "category") val category: UpdateSweepConfigurationV2.Category? = null,

    @SerialName(value = "counterparty") val counterparty: SweepCounterparty? = null,
    ...
    @SerialName(value = "priorities") val priorities: kotlin.collections.List<UpdateSweepConfigurationV2.Priorities>? = null,

    /* The reason for disabling the sweep. */
    @SerialName(value = "reason") val reason: UpdateSweepConfigurationV2.Reason? = null,

    @SerialName(value = "schedule") val schedule: SweepSchedule? = null,

    /* The status of the sweep. If not provided, by default, this is set to **active**.  Possible values:    * **active**:  the sweep is enabled and funds will be pulled in or pushed out based on the defined configuration.    * **inactive**: the sweep is disabled and cannot be triggered.    */
    @SerialName(value = "status") val status: UpdateSweepConfigurationV2.Status? = null,
    ...
    /* The direction of sweep, whether pushing out or pulling in funds to the balance account. If not provided, by default, this is set to **push**.  Possible values:   * **push**: _push out funds_ to a destination balance account or transfer instrument.   * **pull**: _pull in funds_ from a source merchant account, transfer instrument, or balance account. */
    @SerialName(value = "type") val type: UpdateSweepConfigurationV2.Type? = Type.Push
