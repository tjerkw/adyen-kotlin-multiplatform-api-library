 ...
 */
@Serializable
data class BankAccountAccountIdentification (
    ...
    /* **usLocal** */
    @SerialName(value = "type") @Required val type: BankAccountAccountIdentification.Type = Type.UsLocal,
    ...
    @SerialName(value = "accountType") val accountType: BankAccountAccountIdentification.AccountType? = AccountType.Checking,
