 ...
 */
@Serializable
data class TransactionRuleInfo (
    ...
    @SerialName(value = "type") @Required val type: TransactionRuleInfo.Type,
    ...
    @SerialName(value = "outcomeType") val outcomeType: TransactionRuleInfo.OutcomeType? = null,
    ...
    @SerialName(value = "requestType") val requestType: TransactionRuleInfo.RequestType? = null,
    ...
    @SerialName(value = "status") val status: TransactionRuleInfo.Status? = null
