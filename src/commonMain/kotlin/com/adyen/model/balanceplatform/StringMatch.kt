...
data class StringMatch (
    ...
    @SerialName(value = "operation") val operation: StringMatch.Operation? = null,
     ...
     * The type of string matching operation. Possible values:  **startsWith**, **endsWith**, **isEqualTo**, **contains**,
     *
     * Values: Contains,EndsWith,IsEqualTo,StartsWith
     */
    @Serializable
    enum class Operation(val value: kotlin.String) {
        ...
        @SerialName(value = "isEqualTo") IsEqualTo("isEqualTo"),
