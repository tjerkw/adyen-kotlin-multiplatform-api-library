 ...
 */
@Serializable
data class PaginatedPaymentInstrumentsResponse (

    /* Indicates whether there are more items on the next page. */
    @SerialName(value = "hasNext") @Required val hasNext: kotlin.Boolean,

    /* Indicates whether there are more items on the previous page. */
    @SerialName(value = "hasPrevious") @Required val hasPrevious: kotlin.Boolean,

    /* List of payment instruments associated with the balance account. */
    @SerialName(value = "paymentInstruments") @Required val paymentInstruments: kotlin.collections.List<PaymentInstrument>
