 ...
 */
@Serializable
data class CreateSweepConfigurationV2 (
    ...
    @SerialName(value = "category") val category: CreateSweepConfigurationV2.Category? = null,
    ...
    @SerialName(value = "priorities") val priorities: kotlin.collections.List<CreateSweepConfigurationV2.Priorities>? = null,

    /* The reason for disabling the sweep. */
    @SerialName(value = "reason") val reason: CreateSweepConfigurationV2.Reason? = null,

    /* The status of the sweep. If not provided, by default, this is set to **active**.  Possible values:    * **active**:  the sweep is enabled and funds will be pulled in or pushed out based on the defined configuration.    * **inactive**: the sweep is disabled and cannot be triggered.    */
    @SerialName(value = "status") val status: CreateSweepConfigurationV2.Status? = null,
    ...
    /* The direction of sweep, whether pushing out or pulling in funds to the balance account. If not provided, by default, this is set to **push**.  Possible values:   * **push**: _push out funds_ to a destination balance account or transfer instrument.   * **pull**: _pull in funds_ from a source merchant account, transfer instrument, or balance account. */
    @SerialName(value = "type") val type: CreateSweepConfigurationV2.Type? = Type.Push
