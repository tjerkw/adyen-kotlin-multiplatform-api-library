 ...
 */
@Serializable
data class AmountMinMaxRequirement (

    /* **amountMinMaxRequirement** */
    @SerialName(value = "type") @Required val type: AmountMinMaxRequirement.Type = Type.AmountMinMaxRequirement,
     ...
     * **amountMinMaxRequirement**
     *
     * Values: AmountMinMaxRequirement
     */
    @Serializable
    enum class Type(val value: kotlin.String) {
        @SerialName(value = "amountMinMaxRequirement") AmountMinMaxRequirement("amountMinMaxRequirement");
    }
}
