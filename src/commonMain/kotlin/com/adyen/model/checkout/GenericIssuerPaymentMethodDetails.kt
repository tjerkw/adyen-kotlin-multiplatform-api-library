 ...
 */
@Serializable
data class GenericIssuerPaymentMethodDetails (

    /* The issuer id of the shopper's selected bank. */
    @SerialName(value = "issuer") @Required val issuer: kotlin.String,

    /* **genericissuer** */
    @SerialName(value = "type") @Required val type: GenericIssuerPaymentMethodDetails.Type,
     ...
     * **genericissuer**
     *
     * Values: OnlineBankingPL,Eps,OnlineBankingSK,OnlineBankingCZ
     */
    @Serializable
    enum class Type(val value: kotlin.String) {
        @SerialName(value = "onlineBanking_PL") OnlineBankingPL("onlineBanking_PL"),
        @SerialName(value = "eps") Eps("eps"),
        @SerialName(value = "onlineBanking_SK") OnlineBankingSK("onlineBanking_SK"),
        @SerialName(value = "onlineBanking_CZ") OnlineBankingCZ("onlineBanking_CZ");
    }
}
