...
data class PaymentRequest (
    ...
    @SerialName(value = "paymentMethod") @Required val paymentMethod: CheckoutPaymentMethod,
    ...
    @SerialName(value = "channel") val channel: PaymentRequest.Channel? = null,
    ...
    @SerialName(value = "industryUsage") val industryUsage: PaymentRequest.IndustryUsage? = null,
     ...
     * The reason for the amount update. Possible values:  * **delayedCharge**  * **noShow**  * **installment**
     *
     * Values: DelayedCharge,Installment,NoShow
     */
    @Serializable
