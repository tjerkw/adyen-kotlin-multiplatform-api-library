...
data class UpiCollectDetails (
    ...
    /* **upi_collect** */
    @SerialName(value = "type") @Required val type: UpiCollectDetails.Type = Type.UpiCollect,
    ...
    enum class Type(val value: kotlin.String) {
        @SerialName(value = "upi_collect") UpiCollect("upi_collect");
    }
}
