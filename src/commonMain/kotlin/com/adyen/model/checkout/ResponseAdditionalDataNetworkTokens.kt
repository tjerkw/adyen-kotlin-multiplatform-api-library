 ...
 */
@Serializable
data class ResponseAdditionalDataNetworkTokens (

    /* Indicates whether a network token is available for the specified card. */
    @SerialName(value = "networkToken.available") val networkTokenAvailable: kotlin.String? = null,

    /* The Bank Identification Number of a tokenized card, which is the first six digits of a card number. */
    @SerialName(value = "networkToken.bin") val networkTokenBin: kotlin.String? = null,

    /* The last four digits of a network token. */
    @SerialName(value = "networkToken.tokenSummary") val networkTokenTokenSummary: kotlin.String? = null
