 ...
 */
@Serializable
data class AfterpayDetails (

    /* **afterpay_default** */
    @SerialName(value = "type") @Required val type: AfterpayDetails.Type = Type.AfterpayDefault,
     ...
     * **afterpay_default**
     *
     * Values: AfterpayDefault,Afterpaytouch,AfterpayB2b,Clearpay
     */
    @Serializable
    enum class Type(val value: kotlin.String) {
        @SerialName(value = "afterpay_default") AfterpayDefault("afterpay_default"),
