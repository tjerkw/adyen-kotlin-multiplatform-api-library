 ...
 */
@Serializable
data class StandalonePaymentCancelResponse (
    ...
    @SerialName(value = "paymentReference") @Required val paymentReference: kotlin.String,
    ...
    @SerialName(value = "status") @Required val status: StandalonePaymentCancelResponse.Status,
