 ...
 */
@Serializable
data class UpiIntentDetails (

    /* **upi_intent** */
    @SerialName(value = "type") @Required val type: UpiIntentDetails.Type = Type.UpiIntent,
    ...
    enum class Type(val value: kotlin.String) {
        @SerialName(value = "upi_intent") UpiIntent("upi_intent");
    }
}
