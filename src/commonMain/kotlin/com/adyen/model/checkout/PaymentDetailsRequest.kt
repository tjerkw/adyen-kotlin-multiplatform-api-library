...
data class PaymentDetailsRequest (
    ...
    @SerialName(value = "details") @Required val details: PaymentCompletionDetails,

    @SerialName(value = "authenticationData") val authenticationData: DetailsRequestAuthenticationData? = null,
    ...
    @SerialName(value = "threeDSAuthenticationOnly") val threeDSAuthenticationOnly: kotlin.Boolean? = null
