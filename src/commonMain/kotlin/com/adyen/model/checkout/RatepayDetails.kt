 ...
 */
@Serializable
data class RatepayDetails (

    /* **ratepay** */
    @SerialName(value = "type") @Required val type: RatepayDetails.Type = Type.Ratepay,
     ...
     * **ratepay**
     *
     * Values: Ratepay,RatepayDirectdebit
     */
    @Serializable
    enum class Type(val value: kotlin.String) {
        @SerialName(value = "ratepay") Ratepay("ratepay"),
        @SerialName(value = "ratepay_directdebit") RatepayDirectdebit("ratepay_directdebit");
    }
}
