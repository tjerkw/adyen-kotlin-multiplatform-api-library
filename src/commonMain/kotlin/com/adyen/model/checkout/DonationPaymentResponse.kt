 ...
 */
@Serializable
data class DonationPaymentResponse (
    ...
    @SerialName(value = "payment") val payment: PaymentResponse? = null,
    ...
    @SerialName(value = "status") val status: DonationPaymentResponse.Status? = null
