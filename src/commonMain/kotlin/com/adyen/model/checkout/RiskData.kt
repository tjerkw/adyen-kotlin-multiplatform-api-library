...
data class RiskData (
    ...
    @SerialName(value = "clientData") val clientData: kotlin.String? = null,

    /* Any custom fields used as part of the input to configured risk rules. */
    @SerialName(value = "customFields") val customFields: kotlin.collections.Map<kotlin.String, kotlin.String>? = null,
