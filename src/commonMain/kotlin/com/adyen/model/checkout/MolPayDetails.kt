...
data class MolPayDetails (
    ...
    /* **molpay** */
    @SerialName(value = "type") @Required val type: MolPayDetails.Type,
    ...
    enum class Type(val value: kotlin.String) {
        @SerialName(value = "molpay_ebanking_fpx_MY") FpxMY("molpay_ebanking_fpx_MY"),
        @SerialName(value = "molpay_ebanking_TH") TH("molpay_ebanking_TH");
    }
}
