...
data class DragonpayDetails (
    ...
    /* **dragonpay** */
    @SerialName(value = "type") @Required val type: DragonpayDetails.Type,
     ...
     * **dragonpay**
     *
     * Values: Ebanking,OtcBanking,OtcNonBanking,OtcPhilippines
     */
    @Serializable
    enum class Type(val value: kotlin.String) {
        @SerialName(value = "dragonpay_ebanking") Ebanking("dragonpay_ebanking"),
        @SerialName(value = "dragonpay_otc_banking") OtcBanking("dragonpay_otc_banking"),
        @SerialName(value = "dragonpay_otc_non_banking") OtcNonBanking("dragonpay_otc_non_banking"),
        @SerialName(value = "dragonpay_otc_philippines") OtcPhilippines("dragonpay_otc_philippines");
    }
}
