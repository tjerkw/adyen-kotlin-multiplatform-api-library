 ...
 * 
 *
 * @param paymentSession The encoded payment session that you need to pass to the SDK.
...
data class PaymentSetupResponse (
    ...
    @SerialName(value = "paymentSession") val paymentSession: kotlin.String? = null,
    ...
    @SerialName(value = "recurringDetails") val recurringDetails: kotlin.collections.List<RecurringDetail>? = null
