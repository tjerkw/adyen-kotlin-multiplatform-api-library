...
data class CardDetails (
    ...
    @SerialName(value = "fundingSource") val fundingSource: CardDetails.FundingSource? = null,
    ...
    @SerialName(value = "type") val type: CardDetails.Type? = Type.Scheme
     ...
     * Default payment method details. Common for scheme payment methods, and for simple payment method details.
     *
     * Values: Scheme,NetworkToken,Card
     */
    @Serializable
    enum class Type(val value: kotlin.String) {
        @SerialName(value = "scheme") Scheme("scheme"),
        @SerialName(value = "networkToken") NetworkToken("networkToken"),
