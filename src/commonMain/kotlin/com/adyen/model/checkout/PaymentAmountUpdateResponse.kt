 ...
 */
@Serializable
data class PaymentAmountUpdateResponse (
    ...
    @SerialName(value = "status") @Required val status: PaymentAmountUpdateResponse.Status,

    /* The reason for the amount update. Possible values:  * **delayedCharge**  * **noShow**  * **installment** */
    @SerialName(value = "industryUsage") val industryUsage: PaymentAmountUpdateResponse.IndustryUsage? = null,
