...
data class Repayment (
    ...
    @SerialName(value = "basisPoints") @Required val basisPoints: kotlin.Int,

    @SerialName(value = "term") val term: RepaymentTerm? = null,

    @SerialName(value = "threshold") val threshold: ThresholdRepayment? = null
