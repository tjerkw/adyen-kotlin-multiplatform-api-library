 ...
 * @param status The resulting status of the return.  For example: **authorised**, **booked**, **error**.
 * @param transferId The unique identifier of the original transfer.
 */
@Serializable
data class ReturnTransferResponse (
    ...
    @SerialName(value = "status") val status: ReturnTransferResponse.Status? = null,

    /* The unique identifier of the original transfer. */
    @SerialName(value = "transferId") val transferId: kotlin.String? = null
