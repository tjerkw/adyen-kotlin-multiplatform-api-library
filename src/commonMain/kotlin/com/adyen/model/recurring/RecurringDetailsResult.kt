 ...
 */
@Serializable
data class RecurringDetailsResult (

    /* The date when the recurring details were created. */
    @SerialName(value = "creationDate") val creationDate: kotlin.String? = null,

    /* Payment details stored for recurring payments. */
    @SerialName(value = "details") val details: kotlin.collections.List<RecurringDetailWrapper>? = null,

    /* The most recent email for this shopper (if available). */
    @SerialName(value = "lastKnownShopperEmail") val lastKnownShopperEmail: kotlin.String? = null,
