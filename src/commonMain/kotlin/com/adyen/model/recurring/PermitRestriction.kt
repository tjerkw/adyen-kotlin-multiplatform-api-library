 ...
 */
@Serializable
data class PermitRestriction (

    @SerialName(value = "maxAmount") val maxAmount: Amount? = null,

    @SerialName(value = "singleTransactionLimit") val singleTransactionLimit: Amount? = null,

    /* Only a single payment can be made using this permit if set to true, otherwise multiple payments are allowed. */
    @SerialName(value = "singleUse") val singleUse: kotlin.Boolean? = null
