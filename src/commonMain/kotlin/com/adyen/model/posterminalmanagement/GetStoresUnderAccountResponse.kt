 ...
 * 
 *
 * @param stores Array that returns a list of all stores for the specified merchant account, or for all merchant accounts under the company account.
 */
@Serializable
data class GetStoresUnderAccountResponse (
