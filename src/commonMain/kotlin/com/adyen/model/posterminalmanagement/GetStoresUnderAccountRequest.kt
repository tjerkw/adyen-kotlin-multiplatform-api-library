 ...
 * 
 *
 * @param companyAccount The company account. If you only specify this parameter, the response includes the stores of all merchant accounts that are associated with the company account.
 * @param merchantAccount The merchant account. With this parameter, the response only includes the stores of the specified merchant account.
 */
@Serializable
data class GetStoresUnderAccountRequest (
