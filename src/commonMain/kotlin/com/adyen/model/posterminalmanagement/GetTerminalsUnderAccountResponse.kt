 ...
 * 
 *
 * @param companyAccount Your company account.
 * @param inventoryTerminals Array that returns a list of all terminals that are in the inventory of the company account.
 * @param merchantAccounts Array that returns a list of all merchant accounts belonging to the company account.
 */
@Serializable
data class GetTerminalsUnderAccountResponse (
    ...
    @SerialName(value = "merchantAccounts") val merchantAccounts: kotlin.collections.List<MerchantAccount>? = null
