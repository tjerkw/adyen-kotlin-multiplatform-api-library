 ...
 */
@Serializable
data class AdditionalDataModifications (

    /* This is the installment option selected by the shopper. It is required only if specified by the user. */
    @SerialName(value = "installmentPaymentData.selectedInstallmentOption") val installmentPaymentDataSelectedInstallmentOption: kotlin.String? = null
