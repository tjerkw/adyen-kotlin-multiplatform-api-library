 ...
 */
@Serializable
data class PlatformChargebackLogic (
    ...
    @SerialName(value = "behavior") val behavior: PlatformChargebackLogic.Behavior? = null,
    ...
    @SerialName(value = "costAllocationAccount") val costAllocationAccount: kotlin.String? = null,
    ...
    @SerialName(value = "targetAccount") val targetAccount: kotlin.String? = null
     ...
     * The method of handling the chargeback.  Possible values: **deductFromLiableAccount**, **deductFromOneBalanceAccount**, **deductAccordingToSplitRatio**.
     *
     * Values: DeductAccordingToSplitRatio,DeductFromLiableAccount,DeductFromOneBalanceAccount
     */
    @Serializable
    enum class Behavior(val value: kotlin.String) {
