 ...
 */
@Serializable
data class MerchantUpdatedNotificationRequest (

    /* Timestamp for when the webhook was created. */
    @SerialName(value = "createdAt") @Required val createdAt: kotlin.String,

    @SerialName(value = "data") @Required val `data`: AccountUpdateNotificationData,

    /* The environment from which the webhook originated.  Possible values: **test**, **live**. */
    @SerialName(value = "environment") @Required val environment: kotlin.String,

    /* Type of notification. */
    @SerialName(value = "type") @Required val type: MerchantUpdatedNotificationRequest.Type
     ...
     * Type of notification.
     *
     * Values: MerchantPeriodUpdated
     */
    @Serializable
    enum class Type(val value: kotlin.String) {
        @SerialName(value = "merchant.updated") MerchantPeriodUpdated("merchant.updated");
    }
}
