 ...
 */
@Serializable
data class PaymentMethodRequestRemovedNotificationRequest (
    ...
    @SerialName(value = "type") @Required val type: PaymentMethodRequestRemovedNotificationRequest.Type
     ...
     * Type of notification.
     *
     * Values: PaymentMethodPeriodRequestRemoved
     */
    @Serializable
    enum class Type(val value: kotlin.String) {
        @SerialName(value = "paymentMethod.requestRemoved") PaymentMethodPeriodRequestRemoved("paymentMethod.requestRemoved");
    }
}
