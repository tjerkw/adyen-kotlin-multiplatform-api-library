 ...
 */
@Serializable
data class PaymentMethodScheduledForRemovalNotificationRequest (
    ...
    @SerialName(value = "type") @Required val type: PaymentMethodScheduledForRemovalNotificationRequest.Type
     ...
     * Type of notification.
     *
     * Values: PaymentMethodPeriodRequestScheduledForRemoval
     */
    @Serializable
    enum class Type(val value: kotlin.String) {
        @SerialName(value = "paymentMethod.requestScheduledForRemoval") PaymentMethodPeriodRequestScheduledForRemoval("paymentMethod.requestScheduledForRemoval");
    }
}
