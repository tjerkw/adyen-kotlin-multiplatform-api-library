...
data class Settings (
    ...
    @SerialName(value = "band") val band: kotlin.String? = null,

    /* Indicates whether roaming is enabled on the terminals. */
    @SerialName(value = "roaming") val roaming: kotlin.Boolean? = null,

    /* The connection time-out in seconds. Minimum value: 0. */
    @SerialName(value = "timeout") val timeout: kotlin.Int? = null
