 ...
 */
@Serializable
data class CreateMerchantWebhookRequest (

    /* Indicates if the webhook configuration is active. The field must be **true** for us to send webhooks about events related an account. */
    @SerialName(value = "active") @Required val active: kotlin.Boolean,

    /* Format or protocol for receiving webhooks. Possible values: * **soap** * **http** * **json**  */
    @SerialName(value = "communicationFormat") @Required val communicationFormat: CreateMerchantWebhookRequest.CommunicationFormat,
    ...
    @SerialName(value = "encryptionProtocol") val encryptionProtocol: CreateMerchantWebhookRequest.EncryptionProtocol? = null,

    /* Network type for Terminal API notification webhooks. Possible values: * **public** * **local**  Default Value: **public**. */
    @SerialName(value = "networkType") val networkType: CreateMerchantWebhookRequest.NetworkType? = null,
