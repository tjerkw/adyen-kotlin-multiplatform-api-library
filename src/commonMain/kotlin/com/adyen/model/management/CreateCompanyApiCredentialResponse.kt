 ...
 */
@Serializable
data class CreateCompanyApiCredentialResponse (
    ...
    @SerialName(value = "associatedMerchantAccounts") @Required val associatedMerchantAccounts: kotlin.collections.List<kotlin.String>,
