 ...
 */
@Serializable
data class UpdateCompanyWebhookRequest (
    ...
    @SerialName(value = "communicationFormat") val communicationFormat: UpdateCompanyWebhookRequest.CommunicationFormat? = null,

    /* Your description for this webhook configuration. */
    @SerialName(value = "description") val description: kotlin.String? = null,

    /* SSL version to access the public webhook URL specified in the `url` field. Possible values: * **TLSv1.3** * **TLSv1.2** * **HTTP** - Only allowed on Test environment.  If not specified, the webhook will use `sslVersion`: **TLSv1.2**. */
    @SerialName(value = "encryptionProtocol") val encryptionProtocol: UpdateCompanyWebhookRequest.EncryptionProtocol? = null,
    ...
    @SerialName(value = "filterMerchantAccountType") val filterMerchantAccountType: UpdateCompanyWebhookRequest.FilterMerchantAccountType? = null,
    ...
    @SerialName(value = "networkType") val networkType: UpdateCompanyWebhookRequest.NetworkType? = null,
