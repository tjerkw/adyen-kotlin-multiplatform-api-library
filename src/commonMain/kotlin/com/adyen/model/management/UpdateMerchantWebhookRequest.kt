 ...
 */
@Serializable
data class UpdateMerchantWebhookRequest (
    ...
    @SerialName(value = "communicationFormat") val communicationFormat: UpdateMerchantWebhookRequest.CommunicationFormat? = null,

    /* Your description for this webhook configuration. */
    @SerialName(value = "description") val description: kotlin.String? = null,

    /* SSL version to access the public webhook URL specified in the `url` field. Possible values: * **TLSv1.3** * **TLSv1.2** * **HTTP** - Only allowed on Test environment.  If not specified, the webhook will use `sslVersion`: **TLSv1.2**. */
    @SerialName(value = "encryptionProtocol") val encryptionProtocol: UpdateMerchantWebhookRequest.EncryptionProtocol? = null,

    /* Network type for Terminal API notification webhooks. Possible values: * **public** * **local**  Default Value: **public**. */
    @SerialName(value = "networkType") val networkType: UpdateMerchantWebhookRequest.NetworkType? = null,
