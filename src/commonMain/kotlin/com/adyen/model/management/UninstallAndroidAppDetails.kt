 ...
 */
@Serializable
data class UninstallAndroidAppDetails (
    ...
    @SerialName(value = "type") val type: UninstallAndroidAppDetails.Type? = Type.UninstallAndroidApp
     ...
     * Type of terminal action: Uninstall an Android app.
     *
     * Values: UninstallAndroidApp
     */
    @Serializable
    enum class Type(val value: kotlin.String) {
        @SerialName(value = "UninstallAndroidApp") UninstallAndroidApp("UninstallAndroidApp");
    }
}
