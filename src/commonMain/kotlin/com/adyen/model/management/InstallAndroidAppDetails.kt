 ...
 */
@Serializable
data class InstallAndroidAppDetails (
    ...
    @SerialName(value = "type") val type: InstallAndroidAppDetails.Type? = Type.InstallAndroidApp
     ...
     * Type of terminal action: Install an Android app.
     *
     * Values: InstallAndroidApp
     */
    @Serializable
    enum class Type(val value: kotlin.String) {
        @SerialName(value = "InstallAndroidApp") InstallAndroidApp("InstallAndroidApp");
    }
}
