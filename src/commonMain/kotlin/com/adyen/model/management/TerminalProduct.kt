...
data class TerminalProduct (
    ...
    @SerialName(value = "itemsIncluded") val itemsIncluded: kotlin.collections.List<kotlin.String>? = null,

    /* The descriptive name of the product. */
    @SerialName(value = "name") val name: kotlin.String? = null,

    @SerialName(value = "price") val price: TerminalProductPrice? = null
