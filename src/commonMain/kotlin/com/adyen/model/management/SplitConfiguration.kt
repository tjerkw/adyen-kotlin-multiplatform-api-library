 ...
 * @param splitConfigurationId Unique identifier of the split configuration.
 * @param stores List of stores to which the split configuration applies.
 */
@Serializable
data class SplitConfiguration (
    ...
    @SerialName(value = "rules") @Required val rules: kotlin.collections.List<SplitConfigurationRule>,
    ...
    @SerialName(value = "stores") val stores: kotlin.collections.List<kotlin.String>? = null
